...
type GMessage struct {
	...
	SessionId int64         `protobuf:"varint,3,opt,name=sessionId,proto3" json:"sessionId,omitempty"`                      //会话ID
	SeqId     int64         `protobuf:"varint,4,opt,name=seqId,proto3" json:"seqId,omitempty"`                              //消息的编号
...
func (x *GMessage) GetSessionId() int64 {
	if x != nil {
		return x.SessionId
	}
	return 0
...
func (x *GMessage) GetSeqId() int64 {
	if x != nil {
		return x.SeqId
	}
	return 0
...
var file_message_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x65, 0x71, 0x49,
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x65, 0x71, 0x49, 0x64, 0x12, 0x25,
