...
type GMessage struct {
	...
	MsgCode  int32     `protobuf:"varint,2,opt,name=msgCode,proto3" json:"msgCode,omitempty"`                     //消息码 用于表示具体业务类型 参照msgenum.proto中的GAME_MSG_CODE枚举
	SeqId    int32     `protobuf:"varint,3,opt,name=seqId,proto3" json:"seqId,omitempty"`                         //消息的编号
	Notify   *Notify   `protobuf:"bytes,4,opt,name=notify,proto3" json:"notify,omitempty"`                        //通知类型
	Request  *Request  `protobuf:"bytes,5,opt,name=request,proto3" json:"request,omitempty"`                      //请求类型
	Response *Response `protobuf:"bytes,6,opt,name=response,proto3" json:"response,omitempty"`                    //答复类型
}
...
func (x *GMessage) GetMsgCode() int32 {
	if x != nil {
		return x.MsgCode
	}
	return 0
...
var file_message_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xe3, 0x01, 0x0a, 0x08, 0x47, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*Notify)(nil),   // 2: proto.Notify
	(*Request)(nil),  // 3: proto.Request
	(*Response)(nil), // 4: proto.Response
}
var file_message_proto_depIdxs = []int32{
	1, // 0: proto.GMessage.msgType:type_name -> proto.MSG_TYPE
	2, // 1: proto.GMessage.notify:type_name -> proto.Notify
	3, // 2: proto.GMessage.request:type_name -> proto.Request
	4, // 3: proto.GMessage.response:type_name -> proto.Response
