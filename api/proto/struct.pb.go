...
type HeroMsg struct {
	...
	HeroId        int64         `protobuf:"varint,1,opt,name=heroId,proto3" json:"heroId,omitempty"`                                //玩家的ID
...
func (x *HeroMsg) GetHeroId() int64 {
	if x != nil {
		return x.HeroId
	}
	return 0
...
type ItemMsg struct {
	...
	ItemId       int64         `protobuf:"varint,1,opt,name=ItemId,proto3" json:"ItemId,omitempty"`                                //Item的Id
...
func (x *ItemMsg) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
var file_struct_proto_rawDesc = []byte{
	...
	0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x72, 0x6f, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x12, 0x2e,
