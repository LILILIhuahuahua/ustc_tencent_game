...
type HeroMsg struct {
	...
	Invincible    bool          `protobuf:"varint,7,opt,name=invincible,proto3" json:"invincible,omitempty"`                        // 是否处于无敌状态
	SpeedUp       bool          `protobuf:"varint,8,opt,name=speedUp,proto3" json:"speedUp,omitempty"`                              // 是否处于加速状态
	SpeedDown     bool          `protobuf:"varint,9,opt,name=speedDown,proto3" json:"speedDown,omitempty"`                          // 是否处于减速状态
	HeroScore     int32         `protobuf:"varint,10,opt,name=heroScore,proto3" json:"heroScore,omitempty"`                         //玩家分数
}
...
func (x *HeroMsg) GetInvincible() bool {
	if x != nil {
		return x.Invincible
	}
	return false
...
func (x *HeroMsg) GetSpeedUp() bool {
	if x != nil {
		return x.SpeedUp
	}
	return false
...
func (x *HeroMsg) GetSpeedDown() bool {
	if x != nil {
		return x.SpeedDown
	}
	return false
...
func (x *HeroMsg) GetHeroScore() int32 {
	if x != nil {
		return x.HeroScore
	}
	return 0
...
type HeroRankMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HeroId    int32  `protobuf:"varint,1,opt,name=heroId,proto3" json:"heroId,omitempty"`       //玩家id
	HeroName  string `protobuf:"bytes,2,opt,name=heroName,proto3" json:"heroName,omitempty"`    //玩家名
	HeroRank  int32  `protobuf:"varint,3,opt,name=heroRank,proto3" json:"heroRank,omitempty"`   //玩家排名
	HeroScore int32  `protobuf:"varint,4,opt,name=heroScore,proto3" json:"heroScore,omitempty"` //玩家分数
}

func (x *HeroRankMsg) Reset() {
	*x = HeroRankMsg{}
	if protoimpl.UnsafeEnabled {
...
func (x *HeroRankMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HeroRankMsg) ProtoMessage() {}

func (x *HeroRankMsg) ProtoReflect() protoreflect.Message {
	mi := &file_struct_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HeroRankMsg.ProtoReflect.Descriptor instead.
func (*HeroRankMsg) Descriptor() ([]byte, []int) {
	return file_struct_proto_rawDescGZIP(), []int{1}
}

func (x *HeroRankMsg) GetHeroId() int32 {
	if x != nil {
		return x.HeroId
	}
	return 0
...
func (x *HeroRankMsg) GetHeroName() string {
	if x != nil {
		return x.HeroName
	}
	return ""
...
func (x *HeroRankMsg) GetHeroRank() int32 {
	if x != nil {
		return x.HeroRank
	}
	return 0
...
func (x *HeroRankMsg) GetHeroScore() int32 {
	if x != nil {
		return x.HeroScore
	}
	return 0
...
var file_struct_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9, 0x02, 0x0a, 0x07, 0x48, 0x65, 0x72, 0x6f, 0x4d, 0x73, 0x67,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x68, 0x69, 0x67, 0x68, 0x65, 0x73, 0x74, 0x53,
	0x63, 0x6f, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x68, 0x69, 0x67, 0x68,
	0x65, 0x73, 0x74, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06,
...
var file_struct_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_struct_proto_goTypes = []interface{}{
	(*HeroMsg)(nil),      // 0: proto.HeroMsg
	(*HeroRankMsg)(nil),  // 1: proto.HeroRankMsg
	(*ItemMsg)(nil),      // 2: proto.ItemMsg
	(*MapMsg)(nil),       // 3: proto.MapMsg
	(*CoordinateXY)(nil), // 4: proto.CoordinateXY
	(*ConnectMsg)(nil),   // 5: proto.ConnectMsg
	(*RoomMsg)(nil),      // 6: proto.RoomMsg
	(HERO_STATUS)(0),     // 7: proto.HERO_STATUS
	(ENTITY_TYPE)(0),     // 8: proto.ENTITY_TYPE
	(ITEM_STATUS)(0),     // 9: proto.ITEM_STATUS
}
var file_struct_proto_depIdxs = []int32{
	4, // 0: proto.HeroMsg.heroPosition:type_name -> proto.CoordinateXY
	4, // 1: proto.HeroMsg.heroDirection:type_name -> proto.CoordinateXY
	7, // 2: proto.HeroMsg.heroStatus:type_name -> proto.HERO_STATUS
	8, // 3: proto.ItemMsg.ItemType:type_name -> proto.ENTITY_TYPE
	4, // 4: proto.ItemMsg.ItemPosition:type_name -> proto.CoordinateXY
	9, // 5: proto.ItemMsg.ItemStatus:type_name -> proto.ITEM_STATUS
