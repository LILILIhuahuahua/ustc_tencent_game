...
var file_struct_proto_goTypes = []interface{}{
	...
	(HERO_STATUS)(0),     // 6: proto.HERO_STATUS
	(ENTITY_TYPE)(0),     // 7: proto.ENTITY_TYPE
	(ITEM_STATUS)(0),     // 8: proto.ITEM_STATUS
}
var file_struct_proto_depIdxs = []int32{
	...
	6, // 2: proto.HeroMsg.heroStatus:type_name -> proto.HERO_STATUS
	7, // 3: proto.ItemMsg.ItemType:type_name -> proto.ENTITY_TYPE
	4, // 4: proto.ItemMsg.ItemPosition:type_name -> proto.CoordinateXY
	8, // 5: proto.ItemMsg.ItemStatus:type_name -> proto.ITEM_STATUS
